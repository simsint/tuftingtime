...
class __TwigTemplate_cf96b96cf04ec1dba4aa43ab751302e9 extends Template
{
...
<ol>
  <li>";
        // line 19
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>@extend_link</em>. Verify that the Search, Help, and Block modules are installed (or install them if they are not already installed).", ["@extend_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["extend_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 20
  ...
  <li>";
        // line 22
        yield t("Check the indexing status of the Help search page. If it is not fully indexed, see @cron_topic about how to run Cron until indexing is complete.", ["@cron_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["cron_topic"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 23
        yield t("In the future, you can click <em>Rebuild search index</em> on this page, or @cache_topic, in order to force help topic text to be reindexed for searching. This should be done whenever a module, theme, language, or string translation is updated.", ["@cache_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["cache_topic"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 24
  ...
  <li>";
        // line 26
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>@help_link</em>. Verify that the search block is visible, and try a search.", ["@help_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["help_link"] ?? null)), ]);
        yield "</li>
</ol>";
        yield from [];
    }
    ...
    {
        return new Source("", "@help_topics/help.help_topic_search.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/help/help_topics/help.help_topic_search.html.twig");
    }
