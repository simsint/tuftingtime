...
class __TwigTemplate_11c523d51b0f35a5c2f7af5a403dd372 extends Template
{
...
<p>";
        // line 17
        yield t("Change an existing URL alias, to correct the path or the alias value. See @path_overview_topic for more about aliases.", ["@path_overview_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["path_overview_topic"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 18
...
<p>";
        // line 19
        yield t("Users with the <em>@path_permissions_link</em> permission can edit aliases.", ["@path_permissions_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["path_permissions_link"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 20
        yield t("Steps", []);
...
<ol>
  <li>";
        // line 22
        yield t("In the <em>Manage</em> administration menu, navigate to <em>Configuration</em> &gt; <em>Search and metadata</em> &gt; <em>@path_aliases_link</em>. A list of all the site's aliases will appear.", ["@path_aliases_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["path_aliases_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 23
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/path.editing_alias.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/path/help_topics/path.editing_alias.html.twig");
    }
