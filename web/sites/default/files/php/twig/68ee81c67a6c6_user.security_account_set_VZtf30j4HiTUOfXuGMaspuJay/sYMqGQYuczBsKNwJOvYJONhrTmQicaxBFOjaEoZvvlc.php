...
class __TwigTemplate_accadcff610f637e448d407edf0a777c extends Template
{
...
<ol>
  <li>";
        // line 30
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>People</em> &gt; <em>@account_settings_link</em>.", ["@account_settings_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["account_settings_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 31
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/user.security_account_settings.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/user/help_topics/user.security_account_settings.html.twig");
    }
