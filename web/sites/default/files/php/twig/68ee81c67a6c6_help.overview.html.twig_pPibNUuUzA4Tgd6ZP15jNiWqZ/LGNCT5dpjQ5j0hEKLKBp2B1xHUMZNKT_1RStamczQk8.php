...
class __TwigTemplate_6e936e43426ccbd019c9ca6636dc4966 extends Template
{
...
<p>";
        // line 16
        yield t("The top-level help topics are listed at @help_link. Links to other topics, including non-top-level help topics, can be found under the \"Related\" heading when viewing a topic page.", ["@help_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["help_link"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 17
...
<p>";
        // line 20
        yield t("The title and body text of help topics provided by contributed modules and themes are translatable using @translate_link (provided by Interface Translation module). Topics provided by custom modules and themes are also translatable if they have been viewed at least once in a non-English language, which triggers putting their translatable text into the translation database.", ["@translate_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["translate_link"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 21
...
<ul>
  <li><a href=\"https://www.drupal.org/node/3074421\">";
    ...
    {
        return new Source("", "@help_topics/help.overview.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/help/help_topics/help.overview.html.twig");
    }
