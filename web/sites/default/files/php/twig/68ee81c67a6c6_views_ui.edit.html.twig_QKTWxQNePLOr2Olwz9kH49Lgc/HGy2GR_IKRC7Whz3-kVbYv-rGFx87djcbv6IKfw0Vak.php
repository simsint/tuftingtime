...
class __TwigTemplate_89061993191fdfcbaba59c3baff190b8 extends Template
{
...
<ol>
  <li>";
        // line 14
        yield t("If you are not already editing your view, in the <em>Manage</em> administrative menu, navigate to <em>Structure</em> &gt; <em>@views_link</em>. Find the view you want to edit, and click its <em>Edit</em> link.", ["@views_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["views_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 15
  ...
  <li>";
        // line 16
        yield t("Find the section whose settings you want to change, such as <em>Format</em> or <em>Filter criteria</em>. (See @views_overview_topic for more information.)", ["@views_overview_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["views_overview_topic"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 17
...
<ul>
  <li>";
    ...
    {
        return new Source("", "@help_topics/views_ui.edit.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/views_ui/help_topics/views_ui.edit.html.twig");
    }
