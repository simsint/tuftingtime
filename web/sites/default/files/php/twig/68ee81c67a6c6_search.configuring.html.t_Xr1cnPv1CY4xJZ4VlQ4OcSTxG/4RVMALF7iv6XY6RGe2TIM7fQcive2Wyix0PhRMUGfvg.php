...
class __TwigTemplate_d3332f1d5457dd1063e5ba30238c6436 extends Template
{
...
<ol>
  ...
  <li>";
        // line 22
        yield t("Follow the steps in @search_index_topic to make sure that the search index is updated.", ["@search_index_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["search_index_topic"] ?? null)), ]);
        yield "</li>
</ol>";
        yield from [];
    }
    ...
    {
        return new Source("", "@help_topics/search.configuring.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/search/help_topics/search.configuring.html.twig");
    }
