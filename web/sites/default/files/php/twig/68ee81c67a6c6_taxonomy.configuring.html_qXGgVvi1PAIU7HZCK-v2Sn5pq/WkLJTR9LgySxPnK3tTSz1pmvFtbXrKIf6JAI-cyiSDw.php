...
class __TwigTemplate_78998c2048a1f66216779e061a9497b4 extends Template
{
...
<p>";
        // line 20
        yield t("Create a taxonomy vocabulary and add a reference field for that vocabulary to a content entity. See @taxonomy_overview_topic for information about taxonomy and @content_structure_topic for more on content entities.", ["@taxonomy_overview_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["taxonomy_overview_topic"] ?? null)), "@content_structure_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["content_structure_topic"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 21
...
<p>";
        // line 22
        yield t("Users with the <em>@taxonomy_permissions_link</em> permission can configure a vocabulary. To add a field in the administrative interface, the core Field UI module must be installed, and you will also need the <em>Administer fields</em> permission for the entity you are adding the field to.", ["@taxonomy_permissions_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["taxonomy_permissions_link"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 23
        yield t("Steps", []);
...
<ol>
  <li>";
        // line 25
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Structure</em> &gt; <em>@taxonomy_admin_link</em>.", ["@taxonomy_admin_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["taxonomy_admin_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 26
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/structure-taxonomy-setup.html\">";
    ...
    {
        return new Source("", "@help_topics/taxonomy.configuring.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/taxonomy/help_topics/taxonomy.configuring.html.twig");
    }
