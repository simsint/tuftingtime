...
class __TwigTemplate_36297e300e09ec59c1bfab11eea86d94 extends Template
{
...
<p>";
        // line 15
        yield t("Give a content item page a human- or SEO-friendly URL alias; you can follow similar steps to create an alias for a taxonomy term page. See @overview_topic for more about aliases.", ["@overview_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["overview_topic"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 16
...
<p>";
        // line 17
        yield t("Users with the <em>@path_permissions_link</em> permission can create aliases. To follow the steps in this topic, you will also need permission to edit the content item.", ["@path_permissions_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["path_permissions_link"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 18
        yield t("Steps", []);
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-create.html\">";
    ...
    {
        return new Source("", "@help_topics/path.creating_alias.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/path/help_topics/path.creating_alias.html.twig");
    }
