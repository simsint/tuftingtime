...
class __TwigTemplate_4eaa32adc0d9f2c97d7a3f7ce0d41e65 extends Template
{
...
<ol>
  ...
  <li>";
        // line 18
        yield t("Follow the steps in @view_edit_topic to edit the other settings for the display.", ["@view_edit_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["view_edit_topic"] ?? null)), ]);
        yield "</li>
</ol>";
        yield from [];
    }
    ...
    {
        return new Source("", "@help_topics/views_ui.add_display.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/views_ui/help_topics/views_ui.add_display.html.twig");
    }
