...
class __TwigTemplate_3a3da7f5b9bbf473e12850a25c1cf4ec extends Template
{
...
<ol>
  <li>";
        // line 13
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>@extend_link</em>.", ["@extend_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["extend_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 14
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/system.module_install.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/system/help_topics/system.module_install.html.twig");
    }
