...
class __TwigTemplate_300a0b84d0c017ba6a8103118c59399d extends Template
{
...
<p>";
        // line 13
        yield t("Add an entity reference field to an entity sub-type; see @content_structure_topic for more information on entities and reference fields.", ["@content_structure_topic" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["content_structure_topic"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 14
        yield t("Steps", []);
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/field_ui.reference_field.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/field_ui/help_topics/field_ui.reference_field.html.twig");
    }
