...
class __TwigTemplate_f00b58c6f5eb3ad74e4990ace2e4997e extends Template
{
...
<ol>
  <li>";
        // line 14
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Reports</em> &gt; <em>@status_link</em> to see a report that summarizes the health and status of your site. If there are any warnings or errors, you will need to fix them. Take note of any upcoming highly critical security releases that may impact your site.", ["@status_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["status_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 15
...
<ul>
    ...
    {
        return new Source("", "@help_topics/system.reports.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/system/help_topics/system.reports.html.twig");
    }
