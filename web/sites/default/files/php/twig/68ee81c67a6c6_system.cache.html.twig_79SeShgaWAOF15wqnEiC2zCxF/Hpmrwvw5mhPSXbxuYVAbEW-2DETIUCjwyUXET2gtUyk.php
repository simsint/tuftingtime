...
class __TwigTemplate_1981038e2ab55527a2dc180421c296e8 extends Template
{
...
<ol>
  <li>";
        // line 14
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Development</em> &gt; <em>@performance_link</em>.", ["@performance_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["performance_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 15
...
<ul>
    ...
    {
        return new Source("", "@help_topics/system.cache.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/system/help_topics/system.cache.html.twig");
    }
