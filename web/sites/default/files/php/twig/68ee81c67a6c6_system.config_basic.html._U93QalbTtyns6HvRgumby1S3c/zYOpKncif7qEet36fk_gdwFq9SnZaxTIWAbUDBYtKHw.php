...
class __TwigTemplate_25e76247964340d04c99aab68fd261a5 extends Template
{
...
<ol>
  <li>";
        // line 17
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>System</em> &gt; <em>@information_link</em>.", ["@information_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["information_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 18
  ...
  <li>";
        // line 20
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Region and language</em> &gt; <em>@regional_link</em>.", ["@regional_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["regional_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 21
  ...
  <li>";
        // line 23
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Region and language</em> &gt; <em>@datetime_link</em>.", ["@datetime_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["datetime_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 24
...
<p>";
    ...
    {
        return new Source("", "@help_topics/system.config_basic.html.twig", "/Users/rajdeeppaul/Documents/sites/tufting-time/web/core/modules/system/help_topics/system.config_basic.html.twig");
    }
